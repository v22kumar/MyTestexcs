...
(LCA Tejas), MIL-STD-1553B/RS422 telemetry parsing and CCDL \& SPIL verification;
at \textbf{TASL} (UAV R\&D), DFCC and signal-conditioning card integration and the
UAV LRU set.
\end{partnote}
...
\medskip
\small Maps directly to the resume: at BEL (LCA Tejas) --- 1553B/RS422 telemetry
parsing, the Python automation, and CCDL \& SPIL verification under DO-178B Level
A. (At TASL the avionics work is UAV DFCC / signal-conditioning / LRU
integration.) Keep claims to what the resume states; the deep, defensible project
scripting is Chapter 15, built only from \code{inputs/INTAKE.md}.
\end{resumelink}
