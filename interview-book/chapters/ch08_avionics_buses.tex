...
structure \& parsing. This chapter maps directly onto the resume: at \textbf{BEL}
(LCA Tejas MK1/MK1A/MK2, DFCC AETS), MIL-STD-1553B/RS422 telemetry parsing and
DFCC / CCDL / SPIL verification. (At \textbf{TASL} the current UAV work is
autopilot/STM32/LPC1778 embedded development and LRU integration --- a different
domain; keep the two separate.)
\end{partnote}
...
\medskip
\small Maps directly to the resume: at BEL (LCA Tejas, DFCC AETS) --- 1553B/RS422
telemetry parsing, the Python automation, and DFCC / CCDL / SPIL verification
under DO-178B Level A. (At TASL the work is UAV autopilot / STM32 / LPC1778
embedded development and LRU integration.) Keep claims to what the resume states;
the deep, defensible project scripting is Chapter 15, built only from
\code{inputs/INTAKE.md}.
\end{resumelink}
